...
import assFolkloreTypewriter from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/typewriter.png'
import assFolkloreBlueprint from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/blueprint.gif'
import assFolkloreParchment from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/parchment.png'
import assFolkloreRosetta from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/rosetta/rosetta.png'
import assFolkloreRosetta2 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/rosetta/rosetta2.png'
import assFolkloreRosetta3 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/rosetta/rosetta3.png'
import assFolkloreRosetta4 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/rosetta/rosetta4.png'
import assFolkloreFinal01 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/folklore-final-form-01.png'
import assFolkloreFinal02 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/folklore-final-form-02.png'
import assFolkloreFinal03 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/folklore-final-form-03.png'
import assFolkloreFinal04 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/folklore-final-form-04.png'
import assFolkloreFinal05 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/folklore-final-form-05.png'
import assFolkloreFinal06 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/folklore-final-form-06.png'
import assFolkloreFinal07 from 'url:/src/main-stage/threshold/two-cows-one-owl/folklore/folklore-final-form-07.png'
...
import { stoneSmokeTick1, stoneSmokeTick2, stoneSmokeTick3 } from '/src/shared/smoke/_'
import { rollEmInInc, rollEmOut, setRamIcon } from '/src/main-stage/threshold/two-cows-one-owl/owl-ram/_'
import { setScene, subSceneProgress } from '/src/scenes/_'
import { animateBaubleLayer03or04 } from '/src/main-stage/baubles/layer-04/_'
        ...
        if ( g.folklore.binary.gnawSkew < 9 ) {
          ...
          g.tL.cowWow
            .to( extricatedFolkloreFinalForm, {
              duration: 1,
              onComplete: function () {
                setAddOn( '#folkloreFinal', 'click', () => navToPopUp( {
                  url: 'lyrics.html',
                  name: 'lyrics',
                  params: `top=24,left=${g.main.cx / 2},width=${g.main.cx},height=${g.main.cy},menubar=no,toolbar=no,status=no`,
                } ) )
              },
              opacity: 1,
            }, '>' )
